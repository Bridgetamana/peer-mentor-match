  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        ...
        <div className="box-shadow bg-accent/20 p-6 md:p-8">
          <form action={googleSignIn} className="">
            <h1 className='text-center text-2xl font-medium'>Authenticate with Google</h1>
            <p className='mt-3 text-center'>To continue, please sign in with your google account</p>
            <button
              type="submit"
              className="btn-primary !bg-white !px-2 w-full flex items-center justify-center gap-2 mt-6"
            >
