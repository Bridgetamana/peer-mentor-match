        ...
        <main className="max-w-6xl mx-auto px-6 py-20">
          <div className="text-center mb-20">
            ...
            <button
              ...
              className="btn-primary text-lg px-10 py-4 inline-flex items-center gap-2 rounded-full"
            >
              Get Started
          ...
          <div className="text-center bg-gradient-to-r from-green-500 to-emerald-600 rounded-3xl p-12 text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <button
                onClick={handleGetStarted}
                className="bg-white text-green-600 px-10 py-4 rounded-full text-lg font-bold hover:bg-green-50 transition-all duration-200 transform hover:scale-105 cursor-pointer inline-flex items-center gap-2 shadow-lg"
              >
                Create Your Profile
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        {userProfile && (
          <div className="text-center py-8">
            <h2 className="text-xl font-medium mb-4">Profile Created! 🎉</h2>
            <p className="text-[--muted] mb-6">We&apos;re finding your perfect study matches...</p>
            <div className="p-6 border border-[--border] rounded-lg text-left">
              <h3 className="font-medium mb-2">Your Profile:</h3>
              <p className="text-[--muted]">Name: {userProfile.name}</p>
              <p className="text-[--muted]">Role: {userProfile.role === 'learner' ? 'Looking for help' : 'Offering help'}</p>
              <p className="text-[--muted]">Subject: {userProfile.subject || userProfile.subjects?.join(', ')}</p>
            </div>
          </div>
        )}
      </main>
